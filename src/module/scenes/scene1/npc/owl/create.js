export default function OwlCreate(scene) {
    scene.anims.create({
        key: "owl_npc_idle",
        frames: scene.anims.generateFrameNumbers("owl", { start: 0, end: 3 }),
        frameRate: 10,
        repeat: -1 // Loop forever
    });

    // 2) Create the NPC as a physics sprite
    scene.npc = scene.physics.add.sprite(215, 270, 'owl_npc_idle')
    .setOrigin(0.5)
    ...
    scene.npc.anims.play("owl_npc_idle");
